...
namespace SharpGPOAbuse
{
    ...
    {
        [Option(Required = false, HelpText = "Set the domain controller to use.")]
        public string DomainController { get; set; }

        [Option(Required = false, HelpText = "Set the target domain.")]
        public string Domain { get; set; }

        [Option(Required = false, HelpText = "Set the user name")]
        public string Username { get; set; }

        [Option(Required = false, HelpText = "Set the password")]
        public string Password { get; set; }        

        [Option(Required = false, HelpText = "User to set as local admin via the GPO.")]
        public string UserAccount { get; set; }

        [Option(Required = false, HelpText = "GPO to be edited. Need to have edit permission on the GPO.")]
        public string GpoName { get; set; }

        [Option(Required = false, HelpText = "The name of the new immediate task.")]
        public string TaskName { get; set; }

        [Option(Required = false, HelpText = "The author of the new immediate task. Use a domain admin.")]
        public string Author { get; set; }

        [Option(Required = false, HelpText = "Command to execute via the immediate task.")]
        public string Command { get; set; }

        [Option(Required = false, HelpText = "Command arguments of the immediate task.")]
        public string Arguments { get; set; }

        [Option(Required = false, HelpText = "Target computer DNS name for filtered immediate task")]
        public string TargetDnsName { get; set; }

        [Option(Required = false, HelpText = "Target username for filtered immediate task")]
        public string TargetUsername { get; set; }

        [Option(Required = false, HelpText = "Target user SID for filtered immediate task")]
        public string TargetUserSID { get; set; }

        [Option(Required = false, HelpText = "Add new local admin.")]
        public bool AddLocalAdmin { get; set; }

        [Option(Required = false, HelpText = "Add a new immediate task for computer object takeover.")]
        public bool AddComputerTask { get; set; }

        [Option(Required = false, HelpText = "Add a new immediate task for user object takeover.")]
        public bool AddUserTask { get; set; }

        [Option(Required = false, HelpText = "Add rights to a user.")]
        public bool AddUserRights { get; set; }

        [Option(Required = false, HelpText = "New startup script name.")]
        public String UserRights { get; set; }

        [Option(Required = false, HelpText = "Overwrite existing files if required.")]
        public bool Force { get; set; }

        [Option(Required = false, HelpText = "Enable target filtering for user and computer immediate tasks.")]
        public bool FilterEnabled { get; set; }

        [Option(Required = false, HelpText = "Add new user startup script.")]
        public bool AddUserScript { get; set; }

        [Option(Required = false, HelpText = "Add new computer startup script.")]
        public bool AddComputerScript { get; set; }

        [Option(Required = false, HelpText = "New startup script name.")]
        public String ScriptName { get; set; }

        [Option(Required = false, HelpText = "New startup script contents.")]
        public String ScriptContents { get; set; }

        [Option(Required = false, HelpText = "Display help menu.")]
...
[Privilege Rights]";
        ...
        static void Main(string[] args)
        {
            ...
            CommandLine.Parser.Default.ParseArguments<Options>(args).WithParsed<Options>(Options => {
